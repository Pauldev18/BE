...
namespace DichVuSim_BE.Controllers
{
    ...
    public class NguoiDungController : ControllerBase
    {
        ...
        [HttpPost("login")]
        public async Task<ActionResult<NguoiDungDTO>> Login(LoginDTO loginDTO)
        {
            var nguoiDung = await _context.NguoiDungs
                .FirstOrDefaultAsync(nd =>
                    (nd.SoDienThoai == loginDTO.Username || nd.Email == loginDTO.Username) &&
                     nd.MatKhau == loginDTO.MatKhau);
